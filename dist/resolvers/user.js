...
let UserResolver = class UserResolver {
    ...
    forgotPassword(email, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prefixAndToken = constants_1.FORGOT_PASSWORD_PREFIX + token;
            yield sendEmail_1.sendEmail(email, `<a href="http://localhost:3000/change-password/${prefixAndToken}">reset password</a>`);
            return true;
        });
    }
    me({ req, em }) {
    ...
    register(options, { em, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const error = validateRegister_1.validateRegister(options);
            if (error) {
                return { error };
            }
